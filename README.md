...
Planned Functionality: (last updated 07/26/2014)
  ...
  1. A section off of the main menu to find local donation sites 
  	* (Done) salvation army
  	* goodwill?
  	* (Done) churches
  	...

  2. A section off of the main menu to view different stitches. Clicking a stich name from this list will
  ...
  3. A section off of the main menu to vizualize patterns and build them dynamically
  ...
  4. A section off of the main menu to track past donations

  5. A login page

  6. Section for user to set unique options/settings
  ...
  7. Provide localization

  8. Provide/support portrait and landscape orientations
